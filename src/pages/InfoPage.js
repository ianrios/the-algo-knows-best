        ...
        <Col>
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
              ...
              {" "}
              <a href="https://docs.google.com/document/d/1tj1QeCOzNzpLD_msm5PgIIS08yObY-NYgv8jGpOjEy0/edit?usp=sharing" target="_blank" rel="noreferrer" className="stretched-link">
                Paper
              </a>
              {" "}
              (In Progress)
            ...
            <li className="list-group-item">
              ...
              {" "}
              <a href="https://github.com/ianrios/the-algo-knows-best" target="_blank" rel="noreferrer" className="stretched-link" >
            ...
            <li className="list-group-item">
              ...
              {" "}
              <a href="https://github.com/ianrios/thealgobackend" target="_blank" rel="noreferrer" className="stretched-link">
        ...
        <Col>
          <ul className="list-group list-group-flush">
            <li className="list-group-item">
              ...
              {" "}
              <a href="https://www.linkedin.com/in/ian-rios/" target="_blank" rel="noreferrer" className="stretched-link">
                LinkedIn
              </a>
            </li>
            <li className="list-group-item">
              ...
              {" "}
              <a href="https://github.com/ianrios" target="_blank" rel="noreferrer" className="stretched-link">
                GitHub
              </a>
            </li>
            <li className="list-group-item">
